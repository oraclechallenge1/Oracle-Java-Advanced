...
public class Dispensation {
    ...
    private LocalDateTime dateDispensation; // Date (usando LocalDateTime para incluir hora/minuto)

    @Column(name = "WITHDRAWAL_AMOUNT")
    private Integer withdrawalAmount; // Numeric(8) - Usando Integer se o máximo for até 8 dígitos

    @Column(name = "SECTOR_DESTINY", length = 100)
    private String sectorDestiny; // Varchar(100)

    @Column(name = "MOVEMENT_TYPE", length = 50)
    private String movementType; // Varchar(50)

    @Column(name = "OBSERVATION", length = 100)
    private String observation; // Varchar(100)
